...
class SuspendSuggestionProvider_1_20_1(
    private val suggestionProvider: SuspendSuggestionProvider,
        ...
        ApplicationCoroutineScope(coroutineDispatcher, application).launch {
            withApplication(application) {
                suggestionProvider.function(
                    ...
                    this@SuspendSuggestionProvider_1_20_1.commandContextFactory.create(
                        wrappedSender,
                        parameters,
                        css.input
                    )
