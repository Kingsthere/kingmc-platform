...
/**
 * Describe a type of material in minecraft, when an implement of `MaterialType` with data of
 * `null(Unit)` the implement should be a singleton class
 *
 * @since 0.0.7
 * @author kingsthere
 ...
 *              is unconsidered
 */
interface MaterialType<TData> : Keyed, TextDisplayable {
    /**
