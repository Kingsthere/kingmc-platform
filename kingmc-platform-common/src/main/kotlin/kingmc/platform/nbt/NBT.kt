 ...
 */
@WithApplication
inline fun NBTCompound(block: MutableNBTCompound.() -> Unit): NBTCompound {
    return currentApplication().nbtFactory.createMutableNBTCompound().apply(block)
}
/**
 ...
 */
@WithApplication
inline fun MutableNBTCompound(block: MutableNBTCompound.() -> Unit): MutableNBTCompound {
    return currentApplication().nbtFactory.createMutableNBTCompound().apply(block)
}
