...
/**
 * An interface indicating a position for minecraft (x, y, z, world, direction)
 *
 ...
 *
 * This includes also the direction and the world for a position, if you want to
 * describe a position for pure `x, y, z`, use [Location3D] instead
 *
 * @author kingsthere
 * @since 0.0.1
 * @see Location3D
...
interface Location : Location3D {
    ...
    // Kotlin operator function shortcut declaration
