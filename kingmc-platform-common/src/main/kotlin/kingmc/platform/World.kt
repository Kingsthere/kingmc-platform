...
/**
 * A representation of **world**, **world** is the forth dimension of minecraft, a
 * vanilla minecraft server only have 3 dimension:
 *  + world
 *  + world_nether
 *  + world_the_end
 *
...
interface World : EntityProvider, ForwardingAudience, ParticleRecipient, Keyed {
    ...
    /**
     * Gets the [Chunk] at the given coordinates, load it asynchronously if needed.
     *
     * @param x X-coordinate of the chunk
     * @param z Z-coordinate of the chunk
     * @return Chunk at the given coordinates
    ...
    // Companion object for extensional functions
    companion object
}