...
open class NMSOnlinePlayer_1_19_2(val playerNMS: PlayerNMS<Any>,
                                  val nms: NMSServerPlayer_1_19_2,
                                  application: Application)
    : AdventureBukkitPlayer(nms.bukkitEntity, adventureBukkitAudiences.player(nms.bukkitEntity), application), NMSPlayer {
    /**
