...
class BukkitChunkImpl(private val _bukkitChunk: _BukkitChunk,
    ...
    val blockCaches: MutableMap<Triple<Int, Int, Int>, Block> = WeakHashMap()
    ...
    override fun get(x: Int, y: Int, z: Int): Block {
        return blockCaches.computeIfAbsent(Triple(x, y, z)) { BukkitBlockImpl(_bukkitChunk.getBlock(x, y, z), application) }!!
    }
