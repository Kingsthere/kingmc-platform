...
import kingmc.platform.bukkit.AdventureBukkitServer
...
class AdventureAudienceFactory : BukkitAudienceFactory {
    ...
    private val players by lazy {
        AllBukkitPlayer(server)
    }
    private val all by lazy {
        AllBukkitAudiences(server)
    }
