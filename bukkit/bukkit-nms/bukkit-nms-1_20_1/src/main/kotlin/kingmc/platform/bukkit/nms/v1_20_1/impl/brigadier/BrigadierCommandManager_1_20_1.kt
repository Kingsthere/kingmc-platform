...
@Component("brigadierCommandManager_1_20_1")
@ConditionalOnVersion("1.20.1")
@ConditionalOnBean(BrigadierNMS::class)
@Scope(BeanScope.SINGLETON)
@BukkitImplementation
class BrigadierCommandManager_1_20_1 @Autowired constructor(
    @Qualifier("brigadierNMS_1_20_1") private val brigadierNMS: BrigadierNMS_1_20_1,
    ...
    override fun toString(): String {
        return "BrigadierCommandManager_1_20_1(application=$application)"
    }
}